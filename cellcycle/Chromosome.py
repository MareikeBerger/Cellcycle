...
class Chromosome:
    def __init__(self, parameter_dict, t_init, v_init, t_end_blocked=0, active_rep=1, length=0, sites=0, blocked=True, rida=2):
    ...
    def replicate(self, time):
        if self.active_replication == 1:
            if self.length[-1] < 1:
                ...
                # Check whether dars1 and dars2 are being doubled
